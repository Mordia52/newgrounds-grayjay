# Newgrounds Plugin for GrayJay

Watch movies and videos from Newgrounds
...
**[Install Plugin](grayjay://plugin/https://github.com/cpzki/newgrounds-grayjay/releases/latest/download/config.json)**

Or use this URL:

```
grayjay://plugin/https://github.com/cpzki/newgrounds-grayjay/releases/latest/download/config.json
```
...
- **Platform URL**: https://www.newgrounds.com
- **Base API URL**: https://www.newgrounds.com
  - **Author**: cpzki
- **Repository**: https://github.com/cpzki/newgrounds-grayjay
...
For issues and questions, please use the [GitHub Issues](https://github.com/cpzki/newgrounds-grayjay/issues) page.
